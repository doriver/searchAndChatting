...
//        System.out.println(order); // 이거떔에 오류났었음
    ...
    public String listAll(Model model) {
        ...
        LocalDateTime endTime = LocalDateTime.of(2024, 12,31,23,59,59,999999);
    ...
    public String bookStat(Model model) {
        ...
        for (Order order : orderList) {
            ...
            for (OrderItem item : orderItems) {
                ...
                if (map.containsKey(bid)) {
                    ...
                    bookStat.setQuantity(
                            bookStat.getQuantity() + item.getQuantity());
        ...
        for (Map.Entry<Long, BookStat> entry : map.entrySet()) {
            ...
            bookStat.setTotalPrice(
                    bookStat.getUnitPrice() * bookStat.getQuantity());
